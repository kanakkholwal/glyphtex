...
<TabsPrimitive.Trigger
  ...
  class={cn(
    ...
    "cursor-pointer data-active:bg-background dark:data-active:text-foreground dark:data-active:border-border dark:data-active:bg-input/30 data-active:text-foreground",
