...
static KEEP_FFI_EXPORTS: Anchors = Anchors([
    glyphx_tex::glyphx_abi_version as *const c_void,
    glyphx_tex::glyphx_alloc as *const c_void,
    glyphx_tex::glyphx_dealloc as *const c_void,
    glyphx_tex::glyphx_add_file as *const c_void,
    glyphx_tex::glyphx_remove_file as *const c_void,
    glyphx_tex::glyphx_file_count as *const c_void,
    glyphx_tex::glyphx_clear_files as *const c_void,
    glyphx_tex::glyphx_clear_outputs as *const c_void,
    glyphx_tex::glyphx_compile as *const c_void,
    glyphx_tex::glyphx_result_ptr as *const c_void,
    glyphx_tex::glyphx_result_len as *const c_void,
    glyphx_tex::glyphx_output_len as *const c_void,
    glyphx_tex::glyphx_output_copy as *const c_void,
]);
